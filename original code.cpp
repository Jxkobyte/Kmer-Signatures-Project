...
// create new randomly generated signature LEN64
// Density: number of positive numbers in the sequence
// pick that many times to put a number in, check if its 0

short* compute_new_term_sig(char* term, short *term_sig)
{
    // number generator is seeded based on the term & wordlength
...
{
    // check if signature already exists in hash table, otherwise create one
    // dont need to use a hash table because of the special number generator
